...
class SwipeGesture extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _SwipeGestureState();
  }
}

class _SwipeGestureState extends State<SwipeGesture> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _moveAnimation =
        Tween<Offset>(begin: Offset.zero, end: const Offset(1.0, 0.0))
            .animate(CurvedAnimation(parent: _moveController, curve: Curves.easeIn));
